Feature: Reject access requests # TODO DELETE ME
...
#    And "diego@intersect.org.au" should receive an email with subject "Papyri Data Capture - Your access request has been rejected"
#    When I open the email
#    Then I should see "You made a request for access to the Papyri Data Capture System. Your request has been rejected. Please contact the Papyri Data Capture team for further information." in the email body
...
#    Then they should see "You made a request for access to the Papyri Data Capture System. Your request has been rejected. Please contact the Papyri Data Capture team for further information." in the email body
...
#    And I fill in "Login" with "diego@intersect.org.au"
