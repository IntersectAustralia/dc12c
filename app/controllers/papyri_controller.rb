class PapyriController < ApplicationController
  ...
  def advanced_search
    ...
    fields = ['inventory_id', 'general_note', 'lines_of_text', 'paleographic_description', 'recto_verso_note', 'origin_details', 'source_of_acquisition', 'preservation_note', 'language_note', 'summary', 'original_text', 'translated_text']
